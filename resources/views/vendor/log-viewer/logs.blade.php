            ...
            <form id="delete-log-form" action="{{ route('log.delete') }}" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">EXLCUIR ARQUIVO DE LOG</h4>
                    </div>
        ...
        $(function () {
            ...
            $("a[href='#log-modal']").click(function(event) {
                ...
                deleteLogModal.find('.modal-body p').html(
                    'Você tem certeza que deseja <span class="label label-danger">EXCLUIR</span> o arquivo <span class="label label-primary">' + date + '</span> ?'
                );
