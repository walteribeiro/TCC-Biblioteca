...
@section('conteudo')
    ...
    <form class="form-horizontal" action="{{ route('funcionario.update', $funcionario->id) }}" method="post">
        ...
        <div class="form-group">
            <div class="col-lg-5 col-lg-offset-3 col-sm-10">
                ...
                <input type="text" class="form-control" id="nome" name="nome"
                       placeholder="Nome do funcionário" autofocus value="{{ $funcionario->nome }}">
            </div>
        ...
        <div class="form-group">
            <div class="col-lg-2 col-lg-offset-3 col-sm-4">
                ...
                <input type="text" class="form-control" id="telefone" name="telefone"
                       placeholder="Telefone" value="{{ $funcionario->telefone }}" data-inputmask="'mask': '(99) 9999-9999'">
            </div>

            <div class="col-lg-2 col-sm-4">
                <label for="telefone2">Celular</label>
                <input type="text" class="form-control" id="telefone2" name="telefone2"
                       placeholder="Celular" value="{{ $funcionario->telefone2 }}" data-inputmask="'mask': '(99) 99999-9999'">
            </div>
            ...
            <div class="col-lg-2 col-sm-4">
                ...
                <input type="text" class="form-control" id="numeroRegistro" name="numeroRegistro"
                       placeholder="Nº registro" value="{{ $funcionario->matricula }}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2 col-sm-4">
                ...
                <select class="form-control" name="tipoFuncionario" id="tipoFuncionario">
                    ...
                    @elseif($funcionario->tipo_pessoa == 1)
                        <option value="0">Geral</option>
                        <option value="1" selected>Professor</option>
                        <option value="2">Bibliotecário</option>
                    @elseif($funcionario->tipo_pessoa == 2)
                        <option value="0">Geral</option>
                        <option value="1">Professor</option>
